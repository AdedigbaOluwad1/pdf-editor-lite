...
import { FloatingToolbar, StandardToolBar } from './toolbar';
  ...
  return (
    <ViewerContextProvider>
      <div className="w-screen overflow-x-hidden min-h-sceen flex flex-col bg-[#f1f5f8]">
        ...
        <div className="w-screen bg-[#fff] md:hidden min-h-[calc(100dvh-64px)!important] flex items-center text-center justify-center px-4 text-[0.9rem]">
          Actually.. just increase your viewport 😊
          <br />
          Or..
          <br /> Check back later. Support for smaller screens is in the works,
          We can&apos;t wait too.. 😁🔥
        </div>
      </div>
    </ViewerContextProvider>
